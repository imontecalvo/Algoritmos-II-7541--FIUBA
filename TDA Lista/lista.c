...
void destruir_elementos(nodo_t* nodo_a_destruir, nodo_t* nodo_fin){
	...
	destruir_elementos(nodo_a_destruir->siguiente, nodo_fin);
	free(nodo_a_destruir);
}
...
void lista_destruir(lista_t* lista){
	...
	if(lista){
		destruir_elementos(lista->nodo_inicio, lista->nodo_fin);
	}
