...
/*
 * Reemplaza el elemento que se encuentra en la posicion indicada de la lista
 * por el elemento recibido por parámetro. 
 * En caso de que no exista dicha posicion en la lista o directamente no 
 * exista la lista, devolverá -1.
 * En caso de poder hacer el reemplazo, devolverá 0.
 */
...
/*
 * Deja la lista vacía, sin elementos.
 */ 
